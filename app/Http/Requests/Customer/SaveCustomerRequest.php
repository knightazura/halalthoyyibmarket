...
class SaveCustomerRequest extends FormRequest implements RequestValidatorInterface
{
    /**
     ...
     * @var string
     */
    protected $redirectRoute = 'experiment.mn:customer.index-customer';
    ...
    public function messages()
    {
        return [
            ...
            'user_id.unique' => 'Satu user hanya untuk satu pelanggan!',
